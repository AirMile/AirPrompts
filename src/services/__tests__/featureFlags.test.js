...
// Define process globally for tests
...
describe('FeatureFlagsService', () => {
  ...
  describe('initialization', () => {
    ...
    it('should load flags from environment variables', async () => {
      global.process = { env: { REACT_APP_FEATURE_TEST_FLAG: 'true' } };

      await featureFlags.initialize();

      expect(isFeatureEnabled('TEST_FLAG')).toBe(true);

      delete global.process.env.REACT_APP_FEATURE_TEST_FLAG;
    });
  ...
  describe('subscriptions', () => {
    ...
    it('should notify subscribers on flag changes', () => {
      ...
      featureFlags.subscribe('TEST_FLAG', callback);
